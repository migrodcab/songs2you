...
do_i_wanna_know = Cancion.objects.create(Nombre="Do I Wanna Know?",EnlaceYouTube="https://www.youtube.com/watch?v=bpOSxM0rNPM",Album=am)
r_u_mine = Cancion.objects.create(Nombre="R U Mine?",EnlaceYouTube="https://www.youtube.com/watch?v=VQH8ZTgna3Q",Album=am)
one_for_the_road = Cancion.objects.create(Nombre="One For The Road",EnlaceYouTube="https://www.youtube.com/watch?v=qN7gSMPQFss",Album=am)
...
shes_thunderstorms = Cancion.objects.create(Nombre="She's Thunderstorms",EnlaceYouTube="https://www.youtube.com/watch?v=ZQTsKxd0_1k",Album=suck_it_and_see)
black_treacle = Cancion.objects.create(Nombre="Black Treacle",EnlaceYouTube="https://www.youtube.com/watch?v=1wznj4lD1Bs",Album=suck_it_and_see)
...
seaside = Cancion.objects.create(Nombre="Seaside",EnlaceYouTube="https://www.youtube.com/watch?v=7_RZLAxsa8Q",Album=inside_in_inside_out)